...
GiantBat::GiantBat() : myString("A dark shadow falls upon you from above.You turn - a ")
{
	m_health = 30;
	m_attack = 4;
	m_name = "Giant Bat";
...
void GiantBat::Appears()
{
	...
	{		 		
		...
		//std::cout << "A dark shadow falls upon you from above. You turn - a " << m_name << " looms over you, it's enormous wings";
		//std::cout << " buffeting you with great gusts of wind. The " << m_name;
	...
	{
		std::cout << "A " << m_name << " hurtles towards you, preparing to attack. What will you do?\n\n";
	}
}
